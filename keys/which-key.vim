...
" c for cursorhighlight
let g:which_key_map.c = {
      \ 'name' : '+setcursorhighlight',
      \ 's' : [':set cursorline'      , 'cursorhighlight'],
      \ 'u' : [':set nocursorline'    , 'no cursorhighlight'],
      \}
...
let g:which_key_map.t = {
      ...
      \ 'H' : [':FloatermFirst'                              , 'first terminal'],
      \ 'L' : [':FloatermLast'                              , 'last terminal'],
      \ 'k' : [':FloatermKill'                              , 'kill terminal'],
      \ }

let g:which_key_map.w = {
      \ 'name' : '+wordwrap' ,
      \ 's' : [':set wrap|set linebreak'                              , 'word wrap'],
      \ 'u' : [':set nowrap|set nolinebreak'                          , 'no wrap'],
      \}
